...
export class Document {
   ...
   * @returns Promise<msRest.RestResponse>
   */
  createDocuments(documentModels: Models.CyberjusticeLabKernelSharedDocumentModelsCreateDocumentsModel, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse>;
  /**
   * @param documentModels A {CyberjusticeLab.Kernel.Shared.Document.Models.CreateDocumentsModel}
   * object.
   * @param callback The callback
   */
  createDocuments(documentModels: Models.CyberjusticeLabKernelSharedDocumentModelsCreateDocumentsModel, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param documentModels A {CyberjusticeLab.Kernel.Shared.Document.Models.CreateDocumentsModel}
   * object.
   * @param options The optional parameters
   * @param callback The callback
   */
  createDocuments(documentModels: Models.CyberjusticeLabKernelSharedDocumentModelsCreateDocumentsModel, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  createDocuments(documentModels: Models.CyberjusticeLabKernelSharedDocumentModelsCreateDocumentsModel, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.client.sendOperationRequest(
      {
        documentModels,
        options
