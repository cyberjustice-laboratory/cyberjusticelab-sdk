...
export interface CyberjusticeLabKernelSharedDocumentModelsDocumentErrorModel {
  /**
   * @member {string} [documentName] Name of the document
   */
  documentName?: string;
  /**
 ...
 * Contains the Ids of the successfully created documents and a list of each
 * documents that couldm't be created with the associated error message.
 *
 */
export interface CyberjusticeLabKernelSharedDocumentModelsCreateDocumentsResponseModel {
  /**
   * @member {string[]} [documentIds] List of Ids of successfully created
   * documents.
   */
  documentIds?: string[];
  /**
   * @member {CyberjusticeLabKernelSharedDocumentModelsDocumentErrorModel[]}
   * [errors] List of errors, which contains the problematic documents names
   * and the associated error message.
   */
  errors?: CyberjusticeLabKernelSharedDocumentModelsDocumentErrorModel[];
}
...
export interface CyberjusticeLabKernelServiceContractsExchangeForumData {
  ...
  status?: string;
  /**
   * @member {StatusEnum3} [statusEnum] Enum status of the message. Use this to
   * assign the property with a correct enum. Possible values include:
   * 'Active', 'Inactive'
   */
...
export interface CyberjusticeLabKernelServiceContractsJudicialFileRepresentativeData {
  ...
  status?: string;
  /**
   * @member {StatusEnum6} [statusEnum] Enum status of the representative. Use
   * this to assign the property with a correct enum. Possible values include:
   * 'Active', 'Inactive'
   */
...
export interface CyberjusticeLabKernelServiceContractsJudicialFilePleaData {
  ...
  status?: string;
  /**
   * @member {StatusEnum7} [statusEnum] Enum status of the plea. Use this to
...
export interface CyberjusticeLabKernelServiceContractsJudicialFileJudicialFileData {
  ...
  status?: string;
  /**
   * @member {StatusEnum8} [statusEnum] Enum status of the file. Use this to
   * assign the property with a correct enum. Possible values include: 'Empty',
...
export interface CyberjusticeLabKernelSharedJudicialFileModelsRepresentativeModel {
  ...
  status?: string;
  /**
   * @member {StatusEnum9} [statusEnum] Enum status of the representative. Use
   * this to assign the property with a correct enum. Possible values include:
   * 'Active', 'Inactive'
   */
...
export interface CyberjusticeLabKernelSharedJudicialFileModelsPleaModel {
  ...
  status?: string;
  /**
   * @member {StatusEnum10} [statusEnum] Enum status of the plea. Use this to
   * assign the property with a correct enum. Possible values include: 'Empty',
   * 'Invalid', 'Investigation'
   */
...
export interface CyberjusticeLabKernelSharedJudicialFileModelsJudicialFileModel {
  ...
  status?: string;
  /**
   * @member {StatusEnum11} [statusEnum] Enum status of the file. Use this to
   * assign the property with a correct enum. Possible values include: 'Empty',
   * 'Draft', 'InPreparation', 'Planned', 'PartiesIdentification',
   * 'ProblemDescription', 'InitialProposal', 'InitialDocumentFiling',
   * 'FilingCompletion', 'Submitted', 'Initiate', 'Pending', 'Open',
 ...
 * @enum {string}
 */
export type StatusEnum3 = 'Active' | 'Inactive';
 ...
 * @enum {string}
 */
export type StatusEnum7 = 'Empty' | 'Invalid' | 'Investigation';
 ...
 * @enum {string}
 */
export type StatusEnum8 = 'Empty' | 'Draft' | 'InPreparation' | 'Planned' | 'PartiesIdentification' | 'ProblemDescription' | 'InitialProposal' | 'InitialDocumentFiling' | 'FilingCompletion' | 'Submitted' | 'Initiate' | 'Pending' | 'Open' | 'Negotiation' | 'MediationRequest' | 'MediatorAssign' | 'NegoMed' | 'Mediation' | 'MediationCompleted' | 'MinuteApproval' | 'MinuteApprovalRecall' | 'Complete' | 'Adjudication' | 'Reject' | 'Close' | 'Refuse' | 'Invalid';
 ...
 * @enum {string}
 */
export type StatusEnum9 = 'Active' | 'Inactive';
 ...
 * @enum {string}
 */
export type StatusEnum10 = 'Empty' | 'Invalid' | 'Investigation';
 ...
 * @enum {string}
 */
export type StatusEnum11 = 'Empty' | 'Draft' | 'InPreparation' | 'Planned' | 'PartiesIdentification' | 'ProblemDescription' | 'InitialProposal' | 'InitialDocumentFiling' | 'FilingCompletion' | 'Submitted' | 'Initiate' | 'Pending' | 'Open' | 'Negotiation' | 'MediationRequest' | 'MediatorAssign' | 'NegoMed' | 'Mediation' | 'MediationCompleted' | 'MinuteApproval' | 'MinuteApprovalRecall' | 'Complete' | 'Adjudication' | 'Reject' | 'Close' | 'Refuse' | 'Invalid';
